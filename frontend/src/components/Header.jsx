    ...
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-[2vw] py-[5vw] px-[2vw] md:py-[8vw] md:px-[3vw]'>
                ...
                <a href='#specialit' className='flex items-center gap-[1.5vw] bg-white px-[4vw] py-[2vw] rounded-full text-[#595959] text-[2.5vw] md:text-[1.5vw] hover:scale-105 transition-all duration-300'>
